...
export const COMPETITORS: Provider[] = [
  ...
  },
  {
    ...
    url: 'https://elest.io/',
    fromPrice: '$16/mo',
    blurb: 'General-purpose managed-service platform (databases, apps, and AI) with a "Fully Managed OpenClaw" offering.',
    hostsOpenClaw: true,
    hostsHermes: false,
    byokNoMarkup: true,
    isolation: 'Managed VM/container',
    channels: 'Varies by setup',
    note: 'Broad managed-hosting platform, not agent-specific. Backups, SSL, and updates included; no dedicated Hermes option.',
  },
  {
    id: 'betterclaw',
    name: 'BetterClaw',
    ...
    fromPrice: '$5/mo',
    blurb: 'OpenClaw-only managed host with a visual agent builder, no VPS/Docker/SSH, and an audited skills library.',
    hostsOpenClaw: true,
    hostsHermes: false,
    byokNoMarkup: true,
    isolation: 'Managed instance',
    channels: 'Varies by setup',
    note: 'OpenClaw-only, tiers roughly $5–$49/mo. No Hermes option; leans on a visual builder and guardrails as its differentiator.',
  },
  {
    id: 'cloudways',
    name: 'Cloudways',
    url: 'https://www.cloudways.com/en/managed-ai-agents/openclaw-hosting.php',
    fromPrice: 'Varies',
    blurb: 'Established managed-cloud host (DigitalOcean/Linode/Vultr/AWS backends) that added a managed OpenClaw offering.',
    hostsOpenClaw: true,
    hostsHermes: false,
    byokNoMarkup: true,
    isolation: 'Managed VM',
    channels: 'Varies by setup',
    note: 'Broad hosting company extending into agents, not an agent-first platform. No dedicated Hermes support found.',
  },
  {
    id: 'diy-vps',
